...
while running:
    ...
    if wheel: 
        if current_sign_index > 0:
            pygame.draw.polygon(screen, BLUE, ( (int(sun_pos[0]), int(sun_pos[1])), (zodiac_line_points[current_sign_index]), (zodiac_line_points[current_sign_index - 1])))
                
        else: 
            pygame.draw.polygon(screen, BLUE, ( (int(sun_pos[0]), int(sun_pos[1])), (zodiac_line_points[current_sign_index]), (zodiac_line_points[-1])))
