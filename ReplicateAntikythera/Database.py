...
class Database():
    ...
    def initDatabase(self):
        ...
        self.addObject("Jupiter", "Sun", 5.2038, 0.0489, 1.303, 100.464, 273.867, 12, "2023-01-21", "J2000") 
        self.addObject("Saturn", "Sun", 9.53707032, 0.0541506, 2.48446, 113.71504, 339.392, 29, "2032-11-29", "J2000")
        self.addObject("Uranus", "Sun", 19.191, 0.04717, 0.773, 74.006, 96.998857, 84.0205, "2050-08-18", "J2000")
        self.addObject("Neptune", "Sun", 30.07, 0.008678, 1.770, 131.783, 273.187, 165, "2042-09-04", "J2000")
